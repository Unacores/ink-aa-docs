...
URL: `http://api.ink-aa.in/ConnectHub/V1/Accounts/discover`
...
URL: `http://api.ink-aa.in/ConnectHub/V1/Accounts/link`
...
URL: `http://api.ink-aa.in/ConnectHub/V1/Accounts/link/{RefNumber}/{Token}`

e.g. : http://api.ink-aa.in/ConnectHub/V1/Accounts/link/f455409f-6d06-4c8a-ac5a-34c6d78d467a/939504
...
```
e.g.
http://api.ink-aa.in/ConnectHub/V1/Accounts/link/9d4dd3b3-7510-401a-b148-a79f03ac01d9/689612
```
Response Expected: 
```
    {
...
URL: `http://api.ink-aa.in/ConnectHub/V1/FI/request`
...
URL: `http://api.ink-aa.in/ConnectHub/V1/FI/fetch/{SessionID}`
e.g. : http://api.ink-aa.in/ConnectHub/V1/FI/fetch/931d1d33-e332-4ee2-b780-020d43ba69fd
...
URL: `http://api.ink-aa.in/ConnectHub/V1/Consent/Notification`
...
URL: `http://api.ink-aa.in/ConnectHub/V1/Consent`
...
URL: `http://api.ink-aa.in/ConnectHub/V1/Heartbeat`
